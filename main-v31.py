...
# ==========================================
# CRUD DE TEMAS COMERCIALES AVANZADO v31 (REDISEÑADO)
# ==========================================
class VentanaCrudTemas(ctk.CTkToplevel):
    def __init__(self, master, callback_recargar_menu, *args, **kwargs):
        ...
        self.title("Administrar Temas Avanzado v31")
        self.transient(master)
        self.grab_set()
        ...
        # CONTENEDOR CON SCROLL DE LOS GRUPOS DINÁMICOS
        ...
        # -------------------------------------------------------------
        # GRUPO 1: CONFIGURACIÓN BASE & COMPORTAMIENTO TEXTO (EXPANDIDO POR DEFECTO)
        # -------------------------------------------------------------
        ...
        self.ent_titulo_sel = crear_input_color_modular(self.grupo1.frame_content, "Color Título del Prompt Seleccionado:", "#06B6D4", "titulo_sel")

        # -------------------------------------------------------------
        # GRUPO 2: ATÓMICA DE ESTADOS Y ACCIONES (ÉXITO, ACCIÓN, PELIGRO, NEUTRAL)
        # -------------------------------------------------------------
        ...
        # -------------------------------------------------------------
        # GRUPO 3: DISEÑO ESTRUCTURAL DE LISTADO / TARJETAS
        # -------------------------------------------------------------
        self.grupo3 = CollapsibleFrame(frame_scroll_grupos, title="Grupo 3: Estética y Diseño de Tarjetas", expanded=False)
        ...
        self.ent_p_borde = crear_input_color_modular(self.grupo3.frame_content, "Color del Borde:", "#10B981", "p_borde")
        self.ent_p_bg = crear_input_color_modular(self.grupo3.frame_content, "Color de Fondo Tarjeta:", "#111827", "p_bg")
        self.ent_p_hover = crear_input_color_modular(self.grupo3.frame_content, "Color de Reacción Hover:", "#1F2937", "p_hover")
    ...
    def guardar_tema(self):
        ...
        if self.id_tema_seleccionado:
            ...
            ''', (nombre, valores_validados["base"], valores_validados["texto"], valores_validados["exito"], 
                  ...
                  valores_validados["neutral_hover"], valores_validados["titulo_sel"], self.id_tema_seleccionado))
        else:
            cursor.execute('''
                ...
                (nombre, modo, color_base, color_texto, btn_exito, btn_accion, btn_peligro, btn_neutral, prompt_usar_borde, 
                 ...
                 btn_peligro_hover, btn_neutral_hover, color_titulo_sel)
                VALUES (?, 'dark', ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
            ''', (nombre, valores_validados["base"], valores_validados["texto"], valores_validados["exito"], 
                  valores_validados["accion"], valores_validados["peligro"], valores_validados["neutral"], 
                  borde_flag, bg_flag, valores_validados["p_borde"], valores_validados["p_bg"], valores_validados["p_hover"],
                  valores_validados["exito_hover"], valores_validados["accion_hover"], valores_validados["peligro_hover"], 
                  valores_validados["neutral_hover"], valores_validados["titulo_sel"]))
...
def seleccionar_prompt(id_seleccionado, frame_asociado, frame_contenedor):
    ...
    # DINÁMICA DE SELECCIÓN REACCIONANDO AL NUEVO ATRIBUTO DINÁMICO v31
...
def iniciar_aplicacion():
    ...
    root = ctk.CTk()
    root.title("PromptVault Premium v31")
