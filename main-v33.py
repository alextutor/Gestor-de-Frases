...
def inicializar_db_y_config():
    ...
    try:
        ...
        # MIGRACIÓN v33: Categorías y Tags en tabla prompts
        ...
        # MIGRACIONES DE CAMPOS DINÁMICOS v31 y v32
        columnas_nuevas = {
...
def recargar_combobox_categorias_ui():
    ...
    try:
        conn = sqlite3.connect("prompts.sqlite")
        cursor = conn.cursor()
        cursor.execute("SELECT DISTINCT categoria FROM prompts WHERE eliminado_en IS NULL AND categoria IS NOT NULL AND categoria != ''")
        cats = [c[0] for c in cursor.fetchall()]
        conn.close()
    except Exception: cats = []
    
    if "General" not in cats: cats.append("General")
    cats.sort()
    opciones = ["Todos"] + cats
...
# ==========================================
# FORMULARIO MODAL v33 (CON CATEGORÍA Y TAGS)
# ==========================================
class VentanaFormulario(ctk.CTkToplevel):
    def __init__(self, master, prompt_id=None, *args, **kwargs):
        ...
        self.txt_categoria = ctk.CTkEntry(frame_cat, placeholder_text="Ej: Desarrollo, Redacción")
        self.txt_categoria.pack(fill="x", pady=2)
        self.txt_categoria.insert(0, "General")
    ...
    def cargar_datos_existentes(self):
        ...
        if item_cache:
            ...
            self.txt_categoria.delete(0, ctk.END)
            self.txt_categoria.insert(0, item_cache["categoria"])
...
class VentanaCrudTemas(ctk.CTkToplevel):
    def __init__(self, callback_recargar_menu, *args, **kwargs):
        ...
        self.title("Administrar Temas Avanzado v33")
...
# ==========================================
# INTERFAZ Y LOGICA COMPLEMENTARIA v33
# ==========================================
...
def filtrar_prompts_ui(event=None):
    ...
    for reg in resultados:
        ...
        # Bloque de Información Expandido para el Ancho de 750px
...
def cambiar_tema_aplicacion(nombre_tema):
    if nombre_tema in PALETAS:
        ...
        if root:
            ...
            # Refrescar estilos compartidos del buscador, combo y lupa
...
# ==========================================
# ENSAMBLAJE FINAL DEL SOFTWARE v33 (VISTA EXPANDIDA)
# ==========================================
def iniciar_aplicacion():
    ...
    root = ctk.CTk()
    root.title("PromptVault Premium v33")
    
    # Ventana principal ampliada a 750px estilo PhraseVault
    ...
    # -------------------------------------------------------------
    # FILA DE FILTROS AVANZADA (Combo + Input Buscar + Lupa)
    # -------------------------------------------------------------
