...
def inicializar_db_y_config():
    ...
    try:
        ...
        # MIGRACIÓN TABLA DE CATEGORÍAS (v34)
        cursor.execute('''
        ...
        # MIGRACIÓN v33/v34: Columnas en tabla prompts
        ...
        # MIGRACIONES DE CAMPOS DINÁMICOS ESTILOS
        columnas_nuevas = {
...
# ==========================================
# FORMULARIO MODAL v34 (NUEVO/EDITAR PROMPT)
# ==========================================
class VentanaFormulario(ctk.CTkToplevel):
    def __init__(self, master, prompt_id=None, *args, **kwargs):
        ...
        # Combo dinámico restrictivo pero actualizado de Categorías
        ...
        # Bloque de Botones Simétricos Inferiores
        ...
        # CORRECCIÓN: Se eliminaron los parámetros fill="x" y expand=True de la inicialización del CTkButton
...
# ==========================================
# CRUD DE CATEGORÍAS (v34)
# ==========================================
class VentanaCrudCategorias(ctk.CTkToplevel):
    def __init__(self, master, *args, **kwargs):
        super().__init__(master, *args, **kwargs)
        self.title("Administrar Categorías v34")
        self.transient(master)
        self.grab_set()
    ...
    def guardar_categoria(self):
        ...
        # CONTROL RESTRICCIONES: Bloqueo estricto del término "Todos"
...
# ==========================================
# CRUD DE TEMAS COMERCIALES AVANZADO
# ==========================================
class VentanaCrudTemas(ctk.CTkToplevel):
    def __init__(self, callback_recargar_menu, *args, **kwargs):
        ...
        self.title("Administrar Temas Avanzado v34")
...
# ==========================================
# INTERFAZ Y LOGICA COMPLEMENTARIA v34
# ==========================================
...
def filtrar_prompts_ui(event=None):
    global frame_lista_global, txt_buscar, combo_categoria
...
def iniciar_aplicacion():
    ...
    root = ctk.CTk()
    root.title("PromptVault Premium v34")
